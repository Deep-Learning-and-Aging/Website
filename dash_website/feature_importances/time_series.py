...
def get_layout():
    return dbc.Container(
        [
            dcc.Loading([dcc.Store(id="memory_time_series_features", data=get_data_features())]),
                    ...
                    dbc.Col(
                        dcc.Loading(
                            [
                                ...
                                dcc.Graph(id="time_series_left_time_series_features"),
                            ]
                        ),
                        style={"width": 6},
                    ),
                    dbc.Col(
                        dcc.Loading(
                            [
                                ...
                                dcc.Graph(id="time_series_right_time_series_features"),
                            ]
                        ),
                        style={"width": 6},
                    ),
