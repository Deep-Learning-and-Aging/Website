...
TEXT = html.Div(
    [
        ...
        html.Div(html.P("We use three different tabs to present the results:"), style={"text-indent": 0}),
        ...
        html.Div(html.P("For the tab “By category”, aging dimensions can be ordered by:"), style={"text-indent": 0}),
        html.P(
