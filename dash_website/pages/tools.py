...
## S3 credentials
client = client(
    "s3", aws_access_key_id=access_key, aws_secret_access_key=secret_key, config=Config(signature_version="s3v4")
)
...
dict_dataset_images_to_organ_and_view = {
    ...
    "Arterial": {"Carotids": ["Mixed", "LongAxis", "CIMT120", "CIMT150", "ShortAxis"]},
    "Heart": {
        "MRI": [
            "2chambersRaw",
            "2chambersContrast",
