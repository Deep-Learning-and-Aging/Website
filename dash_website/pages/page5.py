...
All = sorted(Biomarkers + Environmental + Socioeconomics + Phenotypes + Diseases + ["FamilyHistory"])
    ...
    [
        ...
        dbc.FormGroup(
            [
                ...
                dcc.Dropdown(id="Select_organ_ewas", options=get_dataset_options(organs), value="Heart"),
                html.Br(),
            ],
    ...
    controls = dbc.Card(
        [
            ...
            dbc.FormGroup(
                [
                    html.P("Select an Organ : "),
                    dcc.Dropdown(id="Select_organ_ewas", options=get_dataset_options([MODE]), value=MODE),
                    html.Br(),
                ],
                id="Select_organ_ewas_full",
                style={"display": "None"},
            ...
            [
                dbc.Row(
                    [
                        ...
                        dbc.Col([dcc.Store(id="memory_ewas"), dcc.Graph(id="Volcano Plot - EWAS")], md=9),
                    ]
                ),
                dbc.Row(
                    [
