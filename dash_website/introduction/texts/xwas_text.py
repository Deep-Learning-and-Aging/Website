...
def get_text_color():
    text = html.Div(
        [
            ...
            html.P("Univariate XWAS - Associations"),
            html.P(
            ...
            html.P("Univariate XWAS - Correlations"),
            html.P(
            ...
            html.P("Correlations by X-dataset"),
            html.P(
            ...
            html.P("Correlations by aging dimension"),
            html.P(
            ...
            html.P("Multivariate XWAS - Prediction of accelerated aging"),
            html.P(
            ...
            html.P("Multivariate XWAS - Feature importances"),
            html.P(
            ...
            html.P("Multivariate XWAS - Correlations"),
            html.P(
