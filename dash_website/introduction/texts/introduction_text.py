...
def get_text_color():
    text = html.Div(
        [
            html.P(
                "This website presents the results of our publication “Analyzing the multidimensionality of biological aging with the tools of deep learning across diverse image-based and physiological indicators yields robust age predictors” which can be found at www.TO_COME_SOON.",
            ),
            html.P(
        ...
        style={
            "background-color": BACKGROUND_COLORS_SECTIONS["introduction"],
            "fontSize": 18,
            "padding": 30,
            "text-align": "justify",
            "text-indent": 30,
    ...
    return text, COLORS_SECTIONS["introduction"]
