        ...
        [
            ...
            dbc.Row(
                [
                    ...
                    dbc.Col(
                        [dcc.Loading(dcc.Graph(id="bar_plot_bar_plot"))],
...
@APP.callback(
    Output("bar_plot_bar_plot", "figure"),
    [Input("main_category_bar_plot", "value"), Input("algorithm_bar_plot", "value")],
)
def _fill_graph_tab_bar_plot(main_category, algorithm):
    return Figure()
