    ...
    controls = dbc.Card([
        dbc.FormGroup([
            ...
            dcc.RadioItems(
                ...
                options = [{'value' : 'eids', 'label' : 'Individuals'},
                          {'value' : 'instances', 'label' : 'Samples'}],
                value = 'instances',
        ...
        dbc.FormGroup([
            ...
            dcc.RadioItems(
                ...
                options = [{'value' : 'withEnsembles', 'label' : 'All models'},
...
def _plot_r2_scores(value_eid_vs_instances,
                    value_aggregate,
                    value_organ,
                    #value_step,
                    value_metric):
    ...
    if value_aggregate == 'bestmodels' and value_organ == 'All' :
        ...
        plots = []
        df_res['organ'] = df_res['organ'].replace('*instances01', 'I01').replace('*instances23', 'I23').replace('*instances1.5x', 'I1.5x')
