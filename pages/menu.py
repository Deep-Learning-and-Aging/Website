            ...
            [
                dbc.Jumbotron(
                    ...
                    """
                        ...
                        html.P(
                            "In this page we study the different tabular data features. For each feature, we can see its distribution, how it is linearly related to the Age, and if the feature is significant in Aging"
                        ),
                        html.Br(),
                        html.Hr(className="my-1"),
                        html.P("Age prediction performances : ", className="lead"),
                        html.P(
                            "We can see how the different models (Images, TimeSeries, Tabular) perform predicting Age. Different metrics are available R2 score and RMSE"
                        ),
                        html.Br(),
                        html.Hr(className="my-1"),
